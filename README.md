...
Чтобы получить части, при запуске проекта нужно запустить init_vault.py. Он сгенерирует master_secret а также разобьёт его на 5 частей.
Для переключения в состояние unsealed нужно 3 ключа.
